...
public class Main {
    ...
    private final static String DATABASE_RESOURCE_LOCATION = "/database/";
    ...
    public Main() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    frame,
                    __("main.database_driver_load_error"),
                    __("main.prisma_puzzle_timer"),
        ...
        if (!databaseFile.exists()) {
            try {
                ...
                JOptionPane.showMessageDialog(
                        frame,
                        String.format(__("main.database_error_message"), e.getMessage()),
                        __("main.prisma_puzzle_timer"),
                        JOptionPane.ERROR_MESSAGE);
                System.exit(0);
            }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    frame,
                    __("main.concurrent_database_access_error_message"),
                    __("main.prisma_puzzle_timer"),
                    JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }
