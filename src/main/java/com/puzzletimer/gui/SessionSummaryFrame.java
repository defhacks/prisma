...
public class SessionSummaryFrame extends JFrame {
    ...
    public SessionSummaryFrame(final CategoryManager categoryManager, SessionManager sessionManager, ConfigurationManager configurationManager, TimerManager timerManager) {
        ...
        categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                setTitle(
                    String.format(
                        __("session_summary.session_sumary_category"),
    ...
    private void createComponents() {
        ...
        // labelSessionSummary
        add(new JLabel(__("session_summary.summary")), "wrap");
        ...
        this.buttonCopyToClipboard = new JButton(__("session_summary.copy_to_clipboard"));
        add(this.buttonCopyToClipboard, "width 150, right, wrap");

        // buttonOk
        this.buttonOk = new JButton(__("session_summary.ok"));
    ...
    private void updateSummary(Category currentCategory, Solution[] solutions) {
        ...
        if (solutions.length >= 1) {
            ...
            // statistics
            String[] labels = {
                __("session_summary.mean"),
                __("session_summary.average"),
                __("session_summary.best_time"),
                __("session_summary.median"),
                __("session_summary.worst_time"),
                __("session_summary.standard_deviation"),
            };
        ...
        // best average of X
        String[] labels = {
            __("session_summary.best_average_of_5"),
            __("session_summary.best_average_of_12"),
            __("session_summary.best_average_of_50"),
        };
