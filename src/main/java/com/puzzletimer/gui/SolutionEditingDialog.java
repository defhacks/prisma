...
public class SolutionEditingDialog extends JDialog {
    ...
    public SolutionEditingDialog(
        ...
        setTitle(__("solution_editing.solution_editor"));
    ...
    private void createComponents() {
        ...
        // labelStart
        add(new JLabel(__("solution_editing.start")));
        ...
        // labelTime
        add(new JLabel(__("solution_editing.time")));
        ...
        // labelPenalty
        add(new JLabel(__("solution_editing.penalty")));
        ...
        // labelScramble
        add(new JLabel(__("solution_editing.scramble")));
        ...
        // labelComment
        add(new JLabel(__("solution_editing.comment")));
        ...
        // buttonOk
        this.buttonOk = new JButton(__("solution_editing.ok"));
        add(this.buttonOk, "tag ok, span 2, split");

        // buttonCancel
        this.buttonCancel = new JButton(__("solution_editing.cancel"));
