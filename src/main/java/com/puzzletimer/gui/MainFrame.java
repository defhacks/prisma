...
public class MainFrame extends JFrame {
    ...
    private class TimesScrollPane extends JScrollPane {
        ...
        private void setSolutions(final Solution[] solutions) {
            ...
            for (int i = 0; i < solutions.length; i++) {
                ...
                labelRetry.setIcon(new ImageIcon(getClass().getResource("/imgs/retry.png")));
                ...
                labelEdit.setIcon(new ImageIcon(getClass().getResource("/imgs/edit.png")));
                                ...
                                new SolutionEditingDialog.SolutionEditingDialogListener() {
                                    ...
                                    public void solutionEdited(Solution solution) {
                                        ...
                                        String[] descriptions = {
                                                ...
                                                __("main.mean_of_3"),
                                                __("main.mean_of_100"),
                                                __("main.average_of_5"),
                                                __("main.average_of_12"),
                                                __("main.average_of_50"),
                                        };
                                        ...
                                        for (int i = 0; i < measures.length; i++) {
                                            ...
                                            if (measures[i].getWindowPosition() == 0 && sessionBest <= allTimeBest) {
                                                MainFrame.this.messageManager.enqueueMessage(
                                                        ...
                                                        String.format(__("main.personal_record_message"),
                ...
                labelX.setIcon(new ImageIcon(getClass().getResource("/imgs/x.png")));
    ...
    private class StatisticsPanel extends JPanel {
        ...
        private void createComponents() {
            ...
            // labelMean
            JLabel labelMeanDescription = new JLabel(__("statistics.mean"));
            ...
            // labelAverage
            JLabel labelAverageDescription = new JLabel(__("statistics.average"));
            ...
            // labelBestTime
            JLabel labelBestTimeDescription = new JLabel(__("statistics.best_time"));
            ...
            // labelMedian
            JLabel labelMedianDescription = new JLabel(__("statistics.median"));
            ...
            // labelWorstTime
            JLabel labelWorstTimeDescription = new JLabel(__("statistics.worst_time"));
            ...
            JLabel labelStandardDeviationDescription = new JLabel(__("statistics.standard_deviation"));
            ...
            // labelMeanOf3
            JLabel labelMeanOf3Description = new JLabel(__("statistics.mean_of_3"));
            ...
            // labelBestMeanOf3
            JLabel labelBestMeanOf3Description = new JLabel(__("statistics.best_mean_of_3"));
            ...
            // labelAverageOf5
            JLabel labelAverageOf5Description = new JLabel(__("statistics.average_of_5"));
            ...
            // labelBestAverageOf5
            JLabel labelBestAverageOf5Description = new JLabel(__("statistics.best_average_of_5"));
            ...
            // labelAverageOf12
            JLabel labelAverageOf12Description = new JLabel(__("statistics.average_of_12"));
            ...
            JLabel labelBestAverageOf12Description = new JLabel(__("statistics.best_average_of_12"));
            ...
            // labelAverageOf50
            JLabel labelAverageOf50Description = new JLabel(__("statistics.average_of_50"));
            ...
            JLabel labelBestAverageOf50Description = new JLabel(__("statistics.best_average_of_50"));
    ...
    private class ScrambleViewerPanel extends JPanel {
        ...
        private void createComponents() {
            ...
            this.hide = new JCheckBox(__("main.hide"));
    ...
    public MainFrame(
            ...
            for (int i = 0; i < inspectionClips.length; i++) {
                ...
                inspectionClips[i].open(
                        AudioSystem.getAudioInputStream(new BufferedInputStream(
                                MainFrame.class.getResourceAsStream("/inspection/" + fileNames[i])
                        )));
            }
        ...
        this.categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                setTitle(
                        String.format(
                                __("main.prisma_puzzle_time_category"),
        ...
        if (UpdateManager.checkUpdate()) {
            ...
            int n = JOptionPane.showOptionDialog(
                    this,
                    __("update.message") + " " + versionNumber + "\n" + changelog,
                    __("update.title"),
        ...
        this.menuItemAddSolution.addActionListener(e -> {
            ...
            solutionEditingDialog.setTitle(__("main.add_solution_title"));
            solutionEditingDialog.setLocationRelativeTo(null);
            solutionEditingDialog.setVisible(true);
        });
        ...
        this.categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                ...
                // category manager
                JMenuItem menuItemCategoryManager = new JMenuItem(__("main.category_manager"));
        ...
        if (timerTriggerId.equals("MANUAL-INPUT")) {
            ...
            if (this.mixerInfo != null) {
                ...
                try {
                    ...
                    MainFrame.this.messageManager.enqueueMessage(
                            MessageType.ERROR,
                            __("main.stackmat_timer_error_message"));
                }
            } else {
                // select the default timer
                this.menuItemSpaceKey.setSelected(true);
    ...
    private void createComponents() {
        ...
        // menuFile
        this.menuFile = new JMenu(__("main.file"));
        this.menuFile.setMnemonic(KeyEvent.VK_F);
        menuBar.add(this.menuFile);

        // menuItemAddSolution
        this.menuItemAddSolution = new JMenuItem(__("main.add_solution"));
        ...
        // menuItemExit
        this.menuItemExit = new JMenuItem(__("main.exit"));
        this.menuItemExit.setMnemonic(KeyEvent.VK_X);
        this.menuFile.add(this.menuItemExit);

        // menuView
        JMenu menuView = new JMenu(__("main.view"));
        menuView.setMnemonic(KeyEvent.VK_V);
        menuBar.add(menuView);

        // menuItemTips
        this.menuItemTips = new JMenuItem(__("main.tips"));
        ...
        // menuItemScrambleQueue
        this.menuItemScrambleQueue = new JMenuItem(__("main.scramble_queue"));
        ...
        // menuItemHistory
        this.menuItemHistory = new JMenuItem(__("main.history"));
        ...
        // menuItemSessionSummary
        this.menuItemSessionSummary = new JMenuItem(__("main.session_summary"));
        ...
        // menuItemStackmatDeveloper
        this.menuItemStackmatDeveloper = new JMenuItem(__("main.stackmat_developer"));
        ...
        // menuCategory
        this.menuCategory = new JMenu(__("main.category"));
        this.menuCategory.setMnemonic(KeyEvent.VK_C);
        menuBar.add(this.menuCategory);

        // menuOptions
        JMenu menuOptions = new JMenu(__("main.options"));
        menuOptions.setMnemonic(KeyEvent.VK_O);
        menuBar.add(menuOptions);

        // menuColorScheme
        this.menuItemColorScheme = new JMenuItem(__("main.color_scheme"));
        ...
        // menuItemInspectionTime
        this.menuItemInspectionTime = new JCheckBoxMenuItem(__("main.inspection_time"));
        ...
        //menuItemAnyKey
        this.menuItemAnyKey = new JCheckBoxMenuItem(__("main.any_key"));
        ...
        //menuItemHideTimer
        this.menuItemHideTimer = new JCheckBoxMenuItem(__("main.hide_timer"));
        menuOptions.add(this.menuItemHideTimer);

        //menuDailySession
        this.menuDailySession = new JCheckBoxMenuItem(__("main.daily_session"));
        menuOptions.add(this.menuDailySession);

        // menuItemSmoothTiming
        this.menuItemSmoothTiming = new JCheckBoxMenuItem(__("main.smooth_timing"));
        ...
        // menuTimerTrigger
        JMenu menuTimerTrigger = new JMenu(__("main.timer_trigger"));
        menuTimerTrigger.setMnemonic(KeyEvent.VK_T);
        menuOptions.add(menuTimerTrigger);
        ButtonGroup timerTriggerGroup = new ButtonGroup();

        // menuItemManualInput
        this.menuItemManualInput = new JRadioButtonMenuItem(__("main.manual_input"));
        ...
        // menuItemCtrlKeys
        this.menuItemCtrlKeys = new JRadioButtonMenuItem(__("main.ctrl_keys"));
        ...
        // menuItemSpaceKey
        this.menuItemSpaceKey = new JRadioButtonMenuItem(__("main.space_key"));
        ...
        // menuItemStackmatTimer
        this.menuItemStackmatTimer = new JRadioButtonMenuItem(__("main.stackmat_timer"));
        ...
        this.stackmatTimerInputDevice = new JMenu(__("main.stackmat_timer_input_device"));
        ...
        // menuLookAndFeel
        this.menuLookAndFeel = new JMenu(__("main.look_and_feel"));
        this.menuLookAndFeel.setMnemonic(KeyEvent.VK_L);
        menuOptions.add(this.menuLookAndFeel);
        this.lookAndFeelGroup = new ButtonGroup();

        // menuItemDefaultLaF
        this.menuItemDefaultLnF = new JRadioButtonMenuItem(__("main.laf_system_default"));
        ...
        // menuTimerPrecision
        JMenu menuTimerPrecision = new JMenu(__("main.timer_precision"));
        ...
        // menuItemCentiseconds
        this.menuItemCentiseconds = new JRadioButtonMenuItem(__("main.centiseconds"));
        ...
        // menuItemMilliseconds
        this.menuItemMilliseconds = new JRadioButtonMenuItem(__("main.milliseconds"));
        ...
        //menuHelp
        JMenu menuHelp = new JMenu(__("main.help"));
        menuHelp.setMnemonic(KeyEvent.VK_H);
        menuBar.add(menuHelp);

        // menuItemFeedback
        this.menuItemFeedback = new JMenuItem(__("main.feedback"));
        this.menuItemFeedback.setMnemonic(KeyEvent.VK_F);
        menuHelp.add(this.menuItemFeedback);

        // menuItemAbout
        this.menuItemAbout = new JMenuItem(__("main.about"));
        ...
        this.statisticsPanel.setBorder(BorderFactory.createTitledBorder(__("main.session_statistics")));
        ...
        this.timesScrollPane.setBorder(BorderFactory.createTitledBorder(__("main.times")));
        ...
        this.scrambleViewerPanel.setBorder(BorderFactory.createTitledBorder(__("main.scramble")));
        panelMain.add(this.scrambleViewerPanel, "w 30%, growy");

        this.scramblePanel.setScrambleViewerPanel(this.scrambleViewerPanel);

        Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/imgs/icon.png"));
