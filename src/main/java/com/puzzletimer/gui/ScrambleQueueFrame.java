...
public class ScrambleQueueFrame extends JFrame {
    ...
    public ScrambleQueueFrame(
        ...
        categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                ...
                setTitle(
                    String.format(
                        __("scramble_queue.scramble_queue-category"),
        ...
        this.buttonImportFromFile.addActionListener(event -> {
            ...
            fileChooser.setFileFilter(new FileNameExtensionFilter(__("scramble_queue.scramble_file_description"), "txt"));
            ...
            try {
                ...
                JOptionPane.showMessageDialog(
                    ...
                    String.format(
                        __("scramble_queue.file_opening_error"),
                        fileChooser.getSelectedFile().getAbsolutePath()),
                    __("scramble_queue.error"),
        ...
        this.buttonExport.addActionListener(event -> {
            JFileChooser fileChooser = new JFileChooser();
            fileChooser.setSelectedFile(new File(__("scramble_queue.default_file_name")));
            fileChooser.setFileFilter(new FileNameExtensionFilter(__("scramble_queue.scramble_file_description"), "txt"));
    ...
    private void createComponents() {
        ...
        // labelQueue
        add(new JLabel(__("scramble_queue.queue")), "span, wrap");
        ...
        // buttonUp
        this.buttonUp = new JButton(__("scramble_queue.up"));
        this.buttonUp.setEnabled(false);
        add(this.buttonUp, "top, growx, split 5, flowy");

        // buttonDown
        this.buttonDown = new JButton(__("scramble_queue.down"));
        this.buttonDown.setEnabled(false);
        add(this.buttonDown, "top, growx");

        // buttonRemove
        this.buttonRemove = new JButton(__("scramble_queue.remove"));
        this.buttonRemove.setEnabled(false);
        add(this.buttonRemove, "top, growx");

        // buttonImportFromFile
        this.buttonImportFromFile = new JButton(__("scramble_queue.import_from_file"));
        add(this.buttonImportFromFile, "gaptop 20, top, growx");

        // buttonExport
        this.buttonExport = new JButton(__("scramble_queue.export_to_file"));
        this.buttonExport.setEnabled(false);
        add(this.buttonExport, "top, growx, wrap");

        // labelImportFromScrambler
        add(new JLabel(__("scramble_queue.import_from_scrambler")), "span, wrap");
        ...
        this.buttonImportFromScrambler = new JButton(__("scramble_queue.import"));
        add(this.buttonImportFromScrambler, "wrap");

        // buttonOK
        this.buttonOk = new JButton(__("scramble_queue.ok"));
    ...
    private void updateTable(Scramble[] queue) {
        ...
        tableModel.addColumn(__("scramble_queue.#"));
        tableModel.addColumn(__("scramble_queue.scramble"));
