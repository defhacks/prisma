...
class CategoryEditorDialog extends JDialog {
    ...
    public CategoryEditorDialog(
        ...
        setTitle(__("category_editor.category_editor"));
    ...
    private void createComponents() {
        ...
        // buttonAdd
        this.buttonTipAdd = new JButton(__("category_editor.add"));
        ...
        // buttonTipUp
        this.buttonTipUp = new JButton(__("category_editor.up"));
        add(this.buttonTipUp, "sizegroup button, top, split 3, flowy");

        // buttonTipDown
        this.buttonTipDown = new JButton(__("category_editor.down"));
        add(this.buttonTipDown, "sizegroup button");

        // buttonTipRemove
        this.buttonTipRemove = new JButton(__("category_editor.remove"));
        add(this.buttonTipRemove, "sizegroup button, wrap");

        // buttonOk
        this.buttonOk = new JButton(__("category_editor.ok"));
        add(this.buttonOk, "tag ok, span 3, split");

        // buttonCancel
        this.buttonCancel = new JButton(__("category_editor.cancel"));
...
public class CategoryManagerFrame extends JFrame {
    ...
    public CategoryManagerFrame(
        ...
        setTitle(__("category_manager.category_manager"));
        ...
        categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                ...
                tableModel.addColumn(__("category_manager.description"));
                tableModel.addColumn(__("category_manager.puzzle"));
                tableModel.addColumn(__("category_manager.scrambler"));
        ...
        this.buttonAdd.addActionListener(event -> {
            Category category = new Category(
                UUID.randomUUID(),
                "RUBIKS-CUBE-RANDOM",
                __("category_manager.new_category"),
                true,
                new String[0]);
        ...
        this.buttonRemove.addActionListener(event -> {
            int result = JOptionPane.showConfirmDialog(
                CategoryManagerFrame.this,
                __("category_manager.category_removal_confirmation_message"),
                __("category_manager.remove_category"),
    ...
    private void createComponents() {
        ...
        // labelCategories
        JLabel labelCategories = new JLabel(__("category_manager.categories"));
        ...
        // buttonAdd
        this.buttonAdd = new JButton(__("category_manager.add"));
        add(this.buttonAdd, "top, growx, split, flowy");

        // buttonEdit
        this.buttonEdit = new JButton(__("category_manager.edit"));
        this.buttonEdit.setEnabled(false);
        add(this.buttonEdit, "growx");

        // buttonRemove
        this.buttonRemove = new JButton(__("category_manager.remove"));
        this.buttonRemove.setEnabled(false);
        add(this.buttonRemove, "growx, wrap");

        // buttonOk
        this.buttonOk = new JButton(__("category_manager.ok"));
