...
public class StackmatDeveloperFrame extends JFrame {
    ...
    public StackmatDeveloperFrame(TimerManager timerManager) {
        ...
        createComponents();
        pack();
        setTitle(__("stackmat_developer.title"));
    ...
    private void createComponents() {
        ...
        // labelGraph
        add(new JLabel(__("stackmat_developer.graph")), "span, wrap");
        ...
        // labelRawData
        add(new JLabel(__("stackmat_developer.raw_data")), "wrap");
        ...
        // button update
        this.buttonUpdate = new JButton(__("stackmat_developer.update"));
        add(this.buttonUpdate, "split, grow");

        // button copy to clipboard
        this.buttonCopyToClipboard = new JButton(__("stackmat_developer.copy_to_clipboard"));
        add(this.buttonCopyToClipboard, "width 150, right, wrap");

        // buttonOk
        this.buttonOk = new JButton(__("stackmat_developer.ok"));
    ...
    public void updateSummary(byte[] data) {
        ...
        if(data != null){
        	...
        	this.textAreaSummary.setText(__("stackmat_developer.error"));
        }
    }
}
