...
public class HistoryFrame extends JFrame {
    private static class SolutionImporterDialog extends JDialog {
        ...
        public SolutionImporterDialog(
            ...
            setTitle(__("solution_importer.solution_importer"));
        ...
        private void createComponents() {
            ...
            // labelSolutions
            add(new JLabel(__("solution_importer.solutions")), "wrap");

            // textAreaContents
            this.textAreaContents = new JTextArea(__("solution_importer.default_contents"));
            JScrollPane scrollPane = new JScrollPane(this.textAreaContents);
            scrollPane.setPreferredSize(new Dimension(0, 0));
            add(scrollPane, "growx, wrap");

            // buttonOk
            this.buttonOk = new JButton(__("solution_importer.ok"));
            add(this.buttonOk, "right, width 100, span 2, split");

            // buttonCancel
            this.buttonCancel = new JButton(__("solution_importer.cancel"));
        ...
        this.buttonRemove.addActionListener(e -> {
            if (HistoryFrame.this.table.getSelectedRows().length > 5) {
                int result = JOptionPane.showConfirmDialog(
                    HistoryFrame.this,
                    __("history.solution_removal_confirmation_message"),
                    __("history.remove_solutions"),
    ...
    private void createComponents() {
        ...
        // labelHistogram
        add(new JLabel(__("history.histogram")), "span, wrap");
        ...
        // labelGraph
        add(new JLabel(__("history.graph")), "span, wrap");
        ...
        // labelStatistics
        add(new JLabel(__("history.statistics")), "span, wrap");
        ...
        // buttonAddSolutions
        this.buttonAddSolutions = new JButton(__("history.add_solutions"));
        add(this.buttonAddSolutions, "growx, top, split 5, flowy");

        // buttonEdit
        this.buttonEdit = new JButton(__("history.edit"));
        this.buttonEdit.setEnabled(false);
        add(this.buttonEdit, "growx, top");

        // buttonRemove
        this.buttonRemove = new JButton(__("history.remove"));
        this.buttonRemove.setEnabled(false);
        add(this.buttonRemove, "growx, top");

        // buttonSelectSession
        this.buttonSelectSession = new JButton(__("history.select_session"));
        add(this.buttonSelectSession, "growx, top, gaptop 16");

        // buttonSelectNone
        this.buttonSelectNone = new JButton(__("history.select_none"));
        add(this.buttonSelectNone, "growx, top, wrap");

        // buttonOk
        this.buttonOk = new JButton(__("history.ok"));
    ...
    private void updateTable(Solution[] solutions) {
        ...
        tableModel.addColumn(__("history.#"));
        tableModel.addColumn(__("history.start"));
        tableModel.addColumn(__("history.time"));
        tableModel.addColumn(__("history.penalty"));
        tableModel.addColumn(__("history.comment"));
        tableModel.addColumn(__("history.scramble"));
