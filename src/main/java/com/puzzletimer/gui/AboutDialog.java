...
public class AboutDialog extends JDialog {
    public AboutDialog(JFrame owner, boolean modal) {
        ...
        setTitle(__("about.prisma_puzzle_timer") + " " + __("about.version"));
        setResizable(false);
    ...
    private void createComponents() {
        ...
        JLabel labelPrismaPuzzleTimer = new JLabel(__("about.prisma_puzzle_timer") + " " + __("about.version"));
        labelPrismaPuzzleTimer.setFont(new Font("Arial", Font.BOLD, 16));
        add(labelPrismaPuzzleTimer, "split 3, gapbottom 10, flowy");

        // labelWalter
        JLabel labelContributors = new JLabel(__("about.contributors"));
