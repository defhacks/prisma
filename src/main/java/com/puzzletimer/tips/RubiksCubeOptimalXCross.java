...
public class RubiksCubeOptimalXCross implements Tip {
    ...
    public String getTipDescription() {
        return __("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS");
    }
    ...
    public String getTip(Scramble scramble) {
        ...
        tip.append(__("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_u")).append(":\n");
        tip.append(getOptimalSolutions(stateU, "x2 "));
        tip.append("\n");

        // x-cross on D
        State stateD = state;
        tip.append(__("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_d")).append(":\n");
        ...
        tip.append(__("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_l")).append(":\n");
        ...
        tip.append(__("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_r")).append(":\n");
        ...
        tip.append(__("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_f")).append(":\n");
        ...
        tip.append(__("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_b")).append(":\n");
